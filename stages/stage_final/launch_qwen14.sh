...
#     --dataset_path=/group-volume/binfeng/wsdm/data/tokenized_qwen14b_final \
...
accelerate launch --config_file "/group-volume/binfeng/wsdm/stage_ppt/config/deepspeed_z3_p4.yaml" distill.py \
    --wandb_project=wsdm_final \
    --run_name=qwen14_ft \
    --tokenizer_path=/group-volume/binfeng/wsdm/ckpt/qwen14b_ppt \
    --model_path=/group-volume/binfeng/wsdm/ckpt/qwen14b_ppt \
    --dataset_path=/group-volume/binfeng/wsdm/data/tokenized_qwen14b_final \
    --model_save_path=/group-volume/binfeng/wsdm/ckpt/qwen14b_ft \
