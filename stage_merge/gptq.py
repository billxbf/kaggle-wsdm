...
MODEL_PATH = "/group-volume/binfeng/wsdm/ckpt/qwen14b_tie_dslerp"
SAVE_PATH = "/group-volume/binfeng/wsdm/ckpt/q4/qwen14b_tie_dslerp_gptq_q4"
MAX_LEN = 3000
...
data = pd.read_parquet(
    "/group-volume/binfeng/wsdm/stage_merge/qwen_ft_text.parquet").sample(n=128, random_state=2024)
