...
def distillation_loss(logits, labels, plab1, plab2, T=1.0, loss_weights=[0.2, 0.2, 0.3, 0.3]):
    ...
    loss = loss_weights[0] * loss_ce + loss_weights[1] * loss_focal + \
        loss_weights[2] * loss_kl1 + loss_weights[3] * loss_kl2
    return loss
...
def main():
    ...
    parser.add_argument("--loss_weights", required=False,
                        type=str, default="[0.2,0.2,0.3,0.3]")
